<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        button.addEventListener('click', function() {
            ...
            document.getElementById('modal-customer-name').textContent = this.dataset.customer;
            document.getElementById('modal-policy-date').textContent = this.dataset.date;
            document.getElementById('modal-net-amount').textContent = '₹' + formatNumber(this.dataset.net);
            document.getElementById('modal-gst').textContent = '₹' + formatNumber(this.dataset.gst);
            document.getElementById('modal-premium').textContent = '₹' + formatNumber(this.dataset.premium);
            document.getElementById('modal-commission').textContent = this.dataset.commission + '₹';
