                ...
                {{-- <div data-w-id="d8b7b9a4-9846-4f96-d345-53159bb96417" style="opacity:0"
                    ...
                    <div class="newsletter-form-block w-form">
                        <form id="newsletter-email-form" name="email-form" data-name="Email Form" method="get"
                            class="newsletter-email-form" data-wf-page-id="65b60c5eef338f6b2401686d"
                            data-wf-element-id="d8b7b9a4-9846-4f96-d345-53159bb96419"><input
                                ...
                                data-name="User Email" placeholder="Enter Your Email..." type="email" id="User-Email"
                                required="" />
                            <div class="newsletter-button-wrap"><input type="submit" data-wait="Please wait..."
                                    class="primary-button w-button" value="Get A Quote" /></div>
                        </form>
            ...
            <div id="w-node-d8b7b9a4-9846-4f96-d345-53159bb96423-2401686d" class="hero-image-block">
                ...
                <div data-w-id="d8b7b9a4-9846-4f96-d345-53159bb96429" style="opacity:0"
                    ...
                    <img src="{{ asset('asset/website/images/icon/3.png') }}"
                        ...
                        class="circle-shape-image width-70px" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="insurance-content-wrap">
                <div data-w-id="ebbe2022-5a73-e986-ee7e-a253abc55302" style="opacity:0" class="insurance-shape-wrap">
                    <a href="#pricePlan" class="insurance-shape-link w-inline-block"><img
                        ...
                        {{-- <div class="insurance-arrow-wrap">
                            <img
                                ...
                                <div data-w-id="ebbe2022-5a73-e986-ee7e-a253abc5530a"
                                    ...
                                    <div class="insurance-card-header-block">
                                        ...
                                        <div class="insurance-logo-wrap"><img alt="Insurance Logo" loading="lazy"
                                                src="{{ asset('asset/website/images/icon96/1.png') }}"
                            ...
                            <div role="listitem" class="insurance-collection-items w-dyn-item">
                                <div data-w-id="ebbe2022-5a73-e986-ee7e-a253abc5530a"
                                    ...
                                    <div class="insurance-card-header-block">
                                        ...
                                        <div class="insurance-logo-wrap"><img alt="Insurance Logo" loading="lazy"
                                                src="{{ asset('asset/website/images/icon96/3.png') }}"
                                                class="insurance-logo" /></div>
                                    </div>
                                    <p class="insurance-summary">Safeguard your bike or scooter with comprehensive
                            ...
                            <div role="listitem" class="insurance-collection-items w-dyn-item">
                                <div data-w-id="ebbe2022-5a73-e986-ee7e-a253abc5530a"
                                    ...
                                    <div class="insurance-card-header-block">
                                        ...
                                        <div class="insurance-logo-wrap"><img alt="Insurance Logo" loading="lazy"
                                                src="{{ asset('asset/website/images/icon96/2.png') }}"
                                                class="insurance-logo" /></div>
                                    </div>
                                    <p class="insurance-summary">Comprehensive Health Protection – Secure your future
                            ...
                            <div role="listitem" class="insurance-collection-items w-dyn-item">
                                <div data-w-id="ebbe2022-5a73-e986-ee7e-a253abc5530a"
                                    ...
                                    <div class="insurance-card-header-block">
                                        ...
                                        <div class="insurance-logo-wrap"><img alt="Insurance Logo" loading="lazy"
                                                src="{{ asset('asset/website/images/icon96/4.png') }}"
                                                class="insurance-logo" /></div>
                                    </div>
                                    <p class="insurance-summary">Protect your car and travel with confidence. Our plans
            ...
            {{-- <div class="insurance-price-content-wrap">
                <div data-current="Tab 1" data-easing="ease" data-duration-in="300" data-duration-out="100"
                    ...
                    <div data-w-id="63e7e0cc-3d52-8875-5bb3-93177ee4250f" class="insurance-tab-toggle w-tab-menu"><a
                            ...
                            <div class="annual-image-wrap"><img width="268" loading="lazy" alt="Annual Save Image"
                ...
                <div class="newsletter-form-block w-form">
                    <form id="email-form" name="email-form" data-name="Email Form" method="get"
                        ...
                        data-wf-element-id="8f2ded18-e9f9-1588-8d22-a340a1e98863"><input
                            class="newsletter-input-field w-input" maxlength="256" name="Email-3" data-name="Email 3"
                            placeholder="Enter Your Email..." type="email" id="Email-3" required="" /><input
